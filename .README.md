## Instruction(Инструкции) (C0-покрытие)
...
## Выбор
* Я выбрал ветки, потому что по моему мнению, это более детальная и тщательная проверка из всех допустимых.